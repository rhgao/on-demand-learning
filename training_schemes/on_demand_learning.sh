#!/bin/bash
# This is the sample script for the on-demand learning training scheme. 
# Please adapt it for your usage based on your own desired validation implementation. 
# The idea is to validate regularly to assess the performance of the snapshot model. 
# The assessment can be based on different factors of your own design, like the average reconstruction loss, average PSNR (currently used in the arXiv paper), etc. 
# The optimal way to get the performance scores for each sub-tasks will be released in the future after publication at a conference.
